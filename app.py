...
def main_app():
    ...
    ">
        <h1 style="color: white; font-family: 'Segoe UI', sans-serif; font-size: 2.8rem; margin-bottom: 0.2rem;">👁‍🗨 Perspēct</h1>
        <p style="font-size: 1.2rem; color: #f0f0f0; font-family: 'Segoe UI', sans-serif; margin-top: 0;">
